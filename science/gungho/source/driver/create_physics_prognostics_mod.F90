...
contains
  ...
  subroutine process_physics_prognostics(processor)
    ...
    call processor%apply(make_spec('dmi_conv', main%convection, Wtheta))
    call processor%apply(make_spec('dmr_conv', main%convection, Wtheta))
    call processor%apply(make_spec('dmg_conv', main%convection, Wtheta))
